        ...
        <section className="bg-surface py-section-mobile md:py-section-desktop">
            <div className="container mx-auto px-gutter">
                <div>
                    ...
                    <h2 className="font-display-lg text-headline-lg font-semibold text-on-surface mb-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-gutter items-start mt-12">
                    <div>
                        ...
                        <p className="font-body-lg text-body-md text-text-secondary leading-relaxed mb-4">
