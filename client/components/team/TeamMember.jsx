    ...
    <>
          ...
          <div className="relative h-full w-full  overflow-y-clip">
            {image ? (
              ...
              <div className="absolute top-[55%] left-1/2 transform -translate-x-1/2 flex items-center justify-center z-20">
                <span className="material-symbols-outlined text-display-lg! text-text-muted">
                  person
                </span>
              </div>
            )}
      ...
      {bio && showBio && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          >
            <div>
              <span className="font-sans text-[10px] font-bold uppercase tracking-widest text-text-muted">
                Team member
              </span>
              <h4
                id={`bio-title-${name.replace(/\s+/g, "-").toLowerCase()}`}
                className="mt-1 font-display text-headline-md font-extrabold uppercase tracking-wide text-primary leading-tight"
              >
                {name}
              </h4>
            ...
            <div className="mt-6 border-t border-border-neutral pt-5">
              <h5 className="font-sans text-xs font-bold uppercase tracking-widest text-text-muted">
                Description
              </h5>
