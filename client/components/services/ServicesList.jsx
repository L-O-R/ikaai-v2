    ...
    return (
        <section className="py-section-mobile md:py-section-desktop px-4 md:px-8 bg-warm-beige">
            <div className="max-w-container-max mx-auto">
                {/* Subtle header — just a label */}
                <div className="mb-10 md:mb-14">
                    <span className="font-label-caps text-label-caps uppercase text-text-muted tracking-widest block">
                        Explore Our Offerings
                    </span>
                    <div className="w-16 h-0.5 bg-harvest-gold/40 mt-3" />
                </div>
                        ...
                        return (
                            ...
                            >
                                ...
                                >
                                    ...
                                    {/* Tags — desktop */}
                                    <div
                                        className={`lg:col-span-4 hidden lg:flex flex-wrap gap-2 justify-end overflow-hidden transition-all duration-500 ease-in-out ${isOpen
