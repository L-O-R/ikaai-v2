          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center bg-surface-container-low rounded-[2.5rem] p-8 md:p-16 border border-border-neutral shadow-xs">
            ...
            <div className="lg:col-span-7 flex flex-col items-start text-left">
              ...
              <p className="font-sans text-body-lg text-text-secondary leading-relaxed max-w-xl">
                We collaborate with governments, development agencies, and
                corporate foundations across India to design, monitor, and
                evaluate high-impact initiatives.
              </p>
            </div>
            ...
            <div className="lg:col-span-5 flex flex-col gap-6 w-full">
              ...
              >
                ...
                <div>
                  ...
                  <p className="font-sans text-xs text-text-muted mt-1.5 leading-relaxed">
                    Partner with us for baseline, midline, endline, and impact
                    evaluation studies.
                  </p>
                </div>
              </Link>
              ...
              >
                ...
                <div>
                  ...
                  <p className="font-sans text-xs text-text-muted mt-1.5 leading-relaxed">
                    Are you a researcher or field coordinator? Connect with
                    Ikaai's pan-India roster.
                  </p>
                </div>
              </Link>
            </div>
