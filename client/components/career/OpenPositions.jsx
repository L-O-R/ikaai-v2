    ...
    >
      <div className="container-size">
        ...
        <div className="text-center mb-12 md:mb-16">
          ...
          <SubHeading text="Join Our" highlightText="Team" />
          ...
          <p className="font-sans text-body-md text-text-secondary max-w-2xl mx-auto mt-4">
            ...
            difference. Explore our current openings and find your place at
            IKAAI India.
          </p>
        </div>
                ...
                >
                  ...
                  >
                    ...
                    <div className="flex items-center gap-3 shrink-0">
                      <span
                        className={`material-symbols-outlined text-text-muted transition-transform duration-300 ${isOpen ? "rotate-180" : ""}`}
                      >
                        expand_more
                      </span>
                    </div>
                  ...
                  >
                    <div className="px-6 pb-6 md:px-8 md:pb-8 pt-2 border-t border-border-neutral">
                      ...
                      <div className="mb-6 rounded-xl border border-border-neutral bg-surface-container-low p-4">
                        <p className="font-sans text-label-caps uppercase text-on-surface">
                          Application details
                        </p>
                        <p className="mt-1 font-sans text-body-md text-text-secondary">
                          {job.experience_level
                            ? `Experience: ${job.experience_level}`
                            : "Experience level available upon review."}
                        </p>
                      ...
                      <div className="rounded-xl border border-border-neutral bg-surface-container-low p-4 md:p-6">
                        <div className="mb-4 flex items-center justify-between gap-3">
                          <div>
                            ...
                            <p className="font-sans text-body-md text-text-secondary">
                              Submit your details and a Google Drive resume
                              link.
                            </p>
                          </div>
                          <button
                        ...
                        <JobApplicationForm
                          jobSlug={selectedJobSlug || job.slug}
