...
const testimonials = [
  {
    id: 1,
    quote:
      "The research provided by IKAAI didn't just give us data; it gave us a roadmap to effectively implement our agricultural policies in regions we previously struggled to reach.",
  ...
  },
  {
    id: 2,
    quote:
      "Working with IKAAI transformed our approach to community engagement. Their evidence-based insights helped us design programs that truly resonate with the needs of rural families.",
  ...
  },
  {
    id: 3,
    quote:
      "The Monitoring & Evaluation framework developed by IKAAI is the most robust we've seen. It has completely changed how we measure our CSR impact across tribal districts.",
  ...
  },
  {
    id: 4,
    quote:
      "IKAAI's field research is unparalleled. Their teams blend academic rigour with deep community trust, resulting in data that is both reliable and human-centered.",
