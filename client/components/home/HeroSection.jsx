...
const images = [
  {
    src: "/hero/community-research-field-visit.jpg",
    label: "Research Begins With Listening",
  },
  {
    src: "/hero/market_research_ikaai.jpg",
    label: "Business Intelligence & Market Research",
  },
  {
    src: "/hero/rural-household-community-engagement.jpg",
    label: "Working Together for Inclusive Development",
  },
  {
    src: "/hero/mushroom-processing-value-chain.jpg",
    label: "From Production to Prosperity",
  },
];
...
const HeroSection = () => {
  ...
  return (
    ...
    <section
      ...
      style={{ height: "100svh", paddingTop: "4.2rem" }}
    >
      {/* ── SLIDESHOW CARD ── 2.5% margin each side, rounded corners */}
      <div className="relative flex-1 overflow-hidden mx-3 sm:mx-6 mb-3 sm:mb-6 rounded-3xl">
        {/* ── IMAGES ── */}
