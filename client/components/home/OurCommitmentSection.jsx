...
const commitments = [
  {
    ...
    description:
      "Supporting evidence-based policy and programme implementation that contributes to India's long-term development goals.",
    icon: "account_balance", // Institution/Pillar icon
  },
  {
    title: "Sustainable Development Goals (SDGs)",
    description:
      "Helping organizations measure, evaluate, and strengthen their contribution to the UN Sustainable Development Goals.",
    icon: "language", // Global Earth icon
  },
  {
    title: "Climate Action & Net Zero",
    description:
      "Supporting sustainability, renewable energy, environmental assessments, and climate-resilient development initiatives.",
    icon: "eco", // Leaf/Eco icon
  },
  {
    title: "Skill Development",
    description:
      "Building institutional capacity through training, knowledge sharing, and evidence-driven learning.",
    icon: "school", // Cap/Academic icon
  },
  {
    title: "Inclusive Growth",
    description:
      "Promoting equitable development through research in health, education, livelihoods, governance, and social inclusion.",
    icon: "groups", // Diverse groups icon
  },
  {
    title: "Innovation & Digital Transformation",
    description:
      "Leveraging technology, AI, GIS, and data analytics to improve decision-making and public service delivery.",
    icon: "memory", // Microchip/Tech icon
  },
  {
    title: "Atmanirbhar Bharat",
    description:
      "Supporting self-reliance through research, policy advisory, MSME development, entrepreneurship, and sustainable livelihood initiatives.",
    icon: "engineering", // Tech/Gears icon
  },
  {
    title: "Sustainable Urban Development",
    description:
      "Supporting sustainable, inclusive, and resilient cities through urban research, planning, governance, and infrastructure advisory.",
    icon: "location_city", // City skyline icon
  },
  {
    title: "Rural Development & Inclusive Growth",
    description:
      "Strengthening rural communities through evidence-based research that enhances livelihoods, agriculture, social welfare, and inclusive development.",
    icon: "agriculture", // Farming/Agriculture icon
  },
  {
    title: "Good Governance & Evidence-Based Policymaking",
    description:
      "Enabling better governance through credible research, monitoring, evaluation, and policy advisory that support informed decision-making.",
        ...
        <div className="flex flex-col md:flex-row md:items-end md:justify-between mb-stack-lg gap-6">
          <div className="max-w-4xl">
            ...
            <p className="text-body-lg text-text-secondary leading-relaxed">
              Aligning institutional research capabilities with strategic
              frameworks and sustainable execution pathways to drive systemic,
          ...
          <div className="flex gap-3 h-fit self-start md:self-end">
            <button
              ...
              className={`w-12 h-12 rounded-full border border-border-neutral flex items-center justify-center transition-all duration-200 cursor-pointer ${
                currentIndex === 0
              ...
              <button
                ...
                onClick={() => {
                  if (scrollContainerRef.current) {
                    const cardWidth =
                      scrollContainerRef.current.firstChild.offsetWidth + 24;
                    scrollContainerRef.current.scrollTo({
