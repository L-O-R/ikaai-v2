          ...
          <div className="container-size relative z-10 flex h-full items-end">
            <ScrollReveal className="max-w-4xl">
              ...
              <p className="mt-stack-lg text-body-lg font-sans text-surface max-w-4xl leading-normal ">
                We uncover the insights behind consumer behaviour, market
                trends, and business performance to help organizations innovate,
                compete, and grow with confidence.
              </p>
            </ScrollReveal>
          </div>
        </div>
