...
const ServiceCard = ({ service, index, isOpen, toggleService }) => {
  ...
  return (
    <div className="service-row group border-b border-border-neutral transition-all duration-300 hover:bg-primary/5">
      <div
        className={`flex flex-col lg:flex-row lg:items-start lg:justify-between gap-6 py-6 md:py-8 lg:py-10 ${
      ...
      >
        ...
        <div className="hidden lg:flex items-start justify-between gap-12 shrink-0 lg:w-105 select-none pl-4">
          ...
          <div className="pt-1">
            <span
              className={`material-symbols-outlined text-text-muted group-hover:text-primary transition-all duration-300 text-2xl ${
                isOpen ? "rotate-45" : ""
              }`}
            >
              add
