    ...
    <div className="border-b border-border-neutral last:border-0 py-5 transition-colors duration-200">
      <h3>
        ...
        >
          ...
          <span
            className={`material-symbols-outlined text-text-secondary group-hover:text-primary transition-transform duration-300 ease-out text-body-md shrink-0 ml-4 ${
        ...
        <div className="container-size relative z-10 text-center md:text-left">
          <div className="max-w-4xl">
            ...
            <p className="text-body-lg text-text-secondary leading-relaxed max-w-2xl">
              Find answers regarding Ikaai India&apos;s services, project
              implementations, empirical research, institutional partnerships,
              ...
              >
                {categories.map((cat) => (
                  <button
                    ...
                    className={`text-body-sm font-semibold px-4 py-2 rounded-full border transition-colors duration-200 cursor-pointer focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary ${
                      activeCategory === cat
      ...
      >
        <div className="container-size px-gutter text-center">
          <div className="max-w-2xl mx-auto space-y-6">
            <div
              className="w-12 h-12 rounded-full bg-warm-beige flex items-center justify-center mx-auto"
              aria-hidden="true"
            >
            ...
            <div className="space-y-2">
              <SubHeading text="Still have" highlightText=" questions?" />
              <p className="text-body-md text-text-secondary leading-relaxed max-w-md mx-auto">
                If you require further support, specific research details, or
                partnership inquiries, please contact our team directly.
              </p>
            </div>
